class TeradataTypeResolver:
    ...
    Like the TypeCompiler, the main process method calls the type's
    _compiler_dispatch method which is generated by the Visitable metaclass.
    But instead of passing an instance of TypeCompiler in as the "visitor"
    we pass in an instance of the TeradataTypeResolver instead which will then
    allow our function call to _compiler_dispatch to redirect to the
    corresponding visit method defined by the TypeResolver below.
    """
