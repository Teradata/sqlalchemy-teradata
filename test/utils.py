...
def parse_show_table_col_attrs(table_str, col_names):
    ...
    Args:
        ...
        col_names: A tuple of strings (column names) specifying which
                   column(s) to parse attributes for. Note these column
                   names must be exactly as they appear in SHOW TABLE
                   (same quoting and case-sensitive).
    ...
    Returns:
        ...
        by that column.
    """
    parsed = [shlex.split(line.strip(', ')) for line in table_str.split('\r')
